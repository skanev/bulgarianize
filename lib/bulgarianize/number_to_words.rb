    ...
    protected
      def words_for(n, gender)
        case n
          ...
          when cond { |n| n % 10 == 0 and n < 100 } then MULTIPLES_OF_10.fetch(n / 10 - 1)
          ...
          when cond { |n| n % 1_000 == 0 and n < 1_000_000 } then "#{words_for(n / 1000, :neuter)} хиляди"
